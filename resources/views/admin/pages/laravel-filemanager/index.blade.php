...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="{{url('')}}/assets/admin/system/filemanager/img/folder.png">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="{{url('')}}/assets/admin/system/filemanager/css/cropper.min.css">
        <style>{!! \File::get(base_path('assets/admin/system/filemanager/css/lfm.css')) !!}</style>
        {{-- Use the line below instead of the above if you need to cache the css. --}}
        {{-- 
        <link rel="stylesheet" href="{{url('')}}/assets/admin/system/filemanager/css/lfm.css">
        --}}
        <link rel="stylesheet" href="{{url('')}}/assets/admin/system/filemanager/css/mfb.css">
        <link rel="stylesheet" href="{{url('')}}/assets/admin/system/filemanager/css/dropzone.min.css">
    ...
    <body>
        ...
        <div id="lfm-loader">
            <img src="{{asset('assets/admin/system/filemanager/img/loader.svg')}}">
        </div>
        <script src="//cdnjs.cloudflare.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
        <script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js"></script>
        <script src="//cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.4.0/bootbox.min.js"></script>
        <script src="//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>
        <script src="{{ asset('assets/admin/system/filemanager/js/cropper.min.js') }}"></script>
        <script src="{{ asset('assets/admin/system/filemanager/js/jquery.form.min.js') }}"></script>
        <script src="{{ asset('assets/admin/system/filemanager/js/dropzone.min.js') }}"></script>
        <script>
            var route_prefix = "{{ url('/') }}";
            var lfm_route = "{{ url(config('lfm.url_prefix', config('lfm.prefix'))) }}";
            var lang = {!! json_encode(trans('laravel-filemanager::lfm')) !!};
        </script>
        <script>{!! \File::get(base_path('assets/admin/system/filemanager/js/script.js')) !!}</script>
        {{-- Use the line below instead of the above if you need to cache the script. --}}
        {{-- <script src="{{ asset('assets/admin/system/filemanager/js/script.js') }}"></script> --}}
        <script>
            $.fn.fab = function () {
              var menu = this;
